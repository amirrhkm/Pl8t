        ...
        <div class="min-h-full">
            <header class="bg-transparent pt-20">
                <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                    <h1 class="text-4xl font-bold text-white text-center drop-shadow-lg">Tally Up</h1>
                    <p class="text-xl text-white text-center mt-2 drop-shadow-md">Please login to your account.</p>
                </div>
            </header>
