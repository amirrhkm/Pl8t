        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="rounded-lg shadow-xl overflow-hidden max-w-4xl mx-auto">
                <div class="flex flex-col md:flex-row">
                    <!-- Login Form -->
                    <div class="w-full md:w-1/2 p-6 md:p-8 bg-black bg-opacity-30 backdrop-filter backdrop-blur-lg flex flex-col justify-center">
                        <h2 class="text-2xl md:text-3xl font-bold text-indigo-400 mb-4 md:mb-6 text-center">Sign in</h2>
                        ...
                        <form action="{{ route('login') }}" method="POST" class="space-y-4 md:space-y-6 max-w-sm mx-auto">
                            ...
                            <div>
                                <div class="relative">
                                    ...
                                    <input id="name" name="name" type="text" required placeholder="Username" class="pl-10 mt-1 block w-full px-3 py-3 md:py-2 bg-white bg-opacity-80 border border-gray-300 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-base md:text-sm">
                                </div>
                                @error('name')
                            ...
                            <div>
                                <div class="relative">
                                    ...
                                    <input id="password" name="password" type="password" required placeholder="Password" class="pl-10 mt-1 block w-full px-3 py-3 md:py-2 bg-white bg-opacity-80 border border-gray-300 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-base md:text-sm">
                            ...
                            <div class="pt-3 md:pt-5 flex justify-center">
                                <button type="submit" class="w-full flex justify-center items-center py-3 md:py-2 px-4 border border-transparent rounded-full shadow-sm text-base md:text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150 ease-in-out">
                    ...
                    <div class="hidden md:block w-full md:w-1/2 bg-indigo-600 p-8 text-white">
