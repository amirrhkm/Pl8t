...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full">
    ...
    <body class="h-full flex items-center justify-center">
        <!-- Mobile Warning -->
        <div class="md:hidden fixed inset-0 bg-gradient-to-br from-indigo-600 to-purple-700 flex items-center justify-center p-6 z-50">
            <div class="bg-white rounded-2xl p-8 shadow-2xl max-w-md text-center">
                ...
                <h2 class="text-2xl font-bold text-gray-800 mb-4">Desktop Experience Recommended</h2>
                <p class="text-gray-600 mb-6">TallyUp works best on larger screens. For the optimal experience utilising our features, please access via desktop or laptop.</p>
                <div class="space-y-4">
                    <div class="bg-indigo-50 rounded-lg p-4">
                        <h3 class="font-semibold text-indigo-800 mb-2">Why Desktop?</h3>
                        <ul class="text-sm text-indigo-700 space-y-2">
                            <li>• Full access to comprehensive dashboard views</li>
                            <li>• Enhanced staff management capabilities</li>
                            <li>• Efficient shift management and assignment</li>
                            <li>• Efficient stock delivery invoice and sales tracking</li>
                            <li>• Optimised payroll processing and monitoring</li>
                        </ul>
                    </div>
                    <p class="text-sm text-gray-500">Mobile optimization coming soon!</p>
                    
                    <!-- Social Links -->
                    <div class="pt-4 border-t border-gray-200">
                        <div class="flex justify-center space-x-4">
                            <a href="https://www.linkedin.com/in/mrnrhkm/" target="_blank" class="text-gray-600 hover:text-indigo-600 transition duration-150 ease-in-out">
                            ...
                            <a href="https://github.com/amirrhkm" target="_blank" class="text-gray-600 hover:text-indigo-600 transition duration-150 ease-in-out">
                        ...
                        <p class="mt-3 text-sm text-gray-500">Crafted by Amir Nurhakim</p>
                    </div>
                </div>
            </div>
        </div>
