    ...
    <div class="bg-gradient-to-br from-indigo-50 to-blue-100 p-8 rounded-xl shadow-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
            <div class="bg-white p-6 rounded-lg shadow-md transition duration-300 ease-in-out hover:shadow-xl flex flex-col items-center justify-center">
                <h3 class="text-lg font-semibold mb-2 text-gray-800">Total Sales</h3>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md transition duration-300 ease-in-out hover:shadow-xl flex flex-col items-center justify-center">
                <h3 class="text-lg font-semibold mb-2 text-gray-800">Credit Card Sales</h3>
                <p class="text-5xl font-bold text-gray-800">{{ number_format($monthlyStats['credit_card_sales'], 2, '.', ',') }}</p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-md transition duration-300 ease-in-out hover:shadow-xl flex flex-col items-center justify-center">
                <h3 class="text-lg font-semibold mb-2 text-gray-800">E-Wallet Sales</h3>
                <p class="text-5xl font-bold text-gray-800">{{ number_format($monthlyStats['ewallet_sales'], 2, '.', ',') }}</p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-md transition duration-300 ease-in-out hover:shadow-xl flex flex-col items-center justify-center">
                <h3 class="text-lg font-semibold mb-2 text-gray-800">Delivery Sales</h3>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-10 transition duration-300 ease-in-out hover:shadow-xl w-full mx-auto text-center">
            ...
            <div class="flex justify-center space-x-4">
                <a href="{{ route('sales.createEod') }}" class="bg-gray-800 hover:bg-green-600 text-white py-2 px-4 rounded-lg transition duration-300 ease-in-out shadow-md hover:shadow-lg text-center text-sm">
                    Add EOD
                </a>
                <a href="{{ route('sales.createBankin') }}" class="bg-gray-800 hover:bg-green-600 text-white py-2 px-4 rounded-lg transition duration-300 ease-in-out shadow-md hover:shadow-lg text-center text-sm">
                    Add Bank-in
                </a>
                <a href="{{ route('sales.createExpense') }}" class="bg-gray-800 hover:bg-green-600 text-white py-2 px-4 rounded-lg transition duration-300 ease-in-out shadow-md hover:shadow-lg text-center text-sm">
                    Add Expense
                </a>
                <a href="{{ route('sales.createEarning') }}" class="bg-gray-800 hover:bg-green-600 text-white py-2 px-4 rounded-lg transition duration-300 ease-in-out shadow-md hover:shadow-lg text-center text-sm">
                    Add Earning
                </a>
            </div>
        </div>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="py-2 px-4 border-b text-sm text-center">
                                            @if($daily->total_eod != 0)
                                                <span class="inline-block bg-gray-200 text-gray-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">
                                                    {{ number_format($daily->total_eod, 2) }}
                                                </span>
                                            @endif
                                        </td>
                                        <td class="py-2 px-4 border-b text-sm text-center">
                                            @if($daily->total_bankin != 0)
                                                <span class="inline-block bg-gray-200 text-gray-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">
                                                    {{ number_format($daily->total_bankin, 2) }}
                                                </span>
                                            @endif
                                        </td>
                                        <td class="py-2 px-4 border-b text-sm text-center">
                                            @if($daily->total_expenses != 0)
                                                <span class="inline-block bg-gray-200 text-gray-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">
                                                    {{ number_format($daily->total_expenses, 2) }}
                                                </span>
                                            @endif
                                        </td>
                                        <td class="py-2 px-4 border-b text-sm text-center">
                                            @if($daily->total_earning != 0)
                                                <span class="inline-block bg-gray-200 text-gray-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">
                                                    {{ number_format($daily->total_earning, 2) }}
                                                </span>
                                            @endif
                                        </td>
                                        <td class="py-2 px-4 border-b text-sm text-center">
                                        ...
                                        <td class="py-2 px-4 border-b text-sm text-center">
                                            @if(isset($dailyCashStreams[$daily->date]))
                                                <span class="inline-block bg-gray-200 text-gray-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">
                                                    {{ number_format($dailyCashStreams[$daily->date], 2) }}
                                                </span>
                                            @endif
                                        </td>
                                        <td class="py-2 px-4 border-b text-sm text-center">
                                            <a href="{{ route('sales.details', ['date' => $daily->date]) }}" 
                                               class="inline-block bg-gray-800 hover:bg-green-600 text-white text-xs font-semibold px-3 py-1 rounded transition duration-300 ease-in-out">
